...
face_cascade = cv2.CascadeClassifier(cv2.data.haarcascades + 'haarcascade_frontalface_alt.xml')  #processing it for our project
if not face_cascade.load(cv2.samples.findFile(cv2.data.haarcascades + 'haarcascade_frontalface_alt.xml')):  #adding a fallback event
